...
if ( ! function_exists( 'inspiry_admin_body_class' ) ) {
	/**
	 * Adds design variation class to the body tag on admin side
	 *
	 * @param $classes
	 *
	 * @return string
	 */
	function inspiry_admin_body_class( $classes ) {
		$classes .= ' design_' . INSPIRY_DESIGN_VARIATION;

		return $classes;
	}

	add_filter( 'admin_body_class', 'inspiry_admin_body_class' );
}