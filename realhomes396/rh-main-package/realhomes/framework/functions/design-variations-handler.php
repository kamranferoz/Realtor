...
if ( ! function_exists( 'inspiry_enqueue_classic_styles' ) ) {
	...
	function inspiry_enqueue_classic_styles() {
		if ( ! is_admin() ) {
			...
			wp_enqueue_style(
				'flexslider',
				get_theme_file_uri( $js_dir_path . 'vendors/flexslider/flexslider.css' ),
				array(),
				'2.6.0',
				'all'
			);
			...
			wp_enqueue_style(
				'pretty-photo-css',
				get_theme_file_uri( $js_dir_path . 'vendors/prettyphoto/css/prettyPhoto.css' ),
				array(),
				'3.1.6',
				'all'
			);
			...
			wp_enqueue_style(
				'swipebox',
				get_theme_file_uri( $js_dir_path . 'vendors/swipebox/css/swipebox.min.css' ),
				array(),
				'1.4.4',
				'all'
			);
			...
			wp_enqueue_style(
				'select2',
				get_theme_file_uri( $js_dir_path . 'vendors/select2/select2.css' ),
				array(),
				'4.0.2',
				'all'
			);
...
if ( ! function_exists( 'inspiry_enqueue_classic_scripts' ) ) {
	...
	function inspiry_enqueue_classic_scripts() {
		if ( ! is_admin() ) {
			...
			wp_register_script(
				'flexslider',
				get_theme_file_uri( $js_dir_path . 'vendors/flexslider/jquery.flexslider-min.js' ),
				array( 'jquery' ),
				'2.6.0',
				false
			);
			...
			wp_register_script(
				'pretty-photo',
				get_theme_file_uri( $js_dir_path . 'vendors/prettyphoto/jquery.prettyPhoto.js' ),
				array( 'jquery' ),
				'3.1.6',
				false
			);
			...
			wp_register_script(
				'isotope',
				get_theme_file_uri( $js_dir_path . 'vendors/isotope.pkgd.min.js' ),
				array( 'jquery' ),
				'2.1.1',
				false
			);
			...
			wp_register_script(
				'jqvalidate',
				get_theme_file_uri( $js_dir_path . 'vendors/jquery.validate.min.js' ),
				array( 'jquery' ),
				'1.11.1',
				false
			);
			...
			wp_register_script(
				'jqform',
				get_theme_file_uri( $js_dir_path . 'vendors/jquery.form.js' ),
				array( 'jquery' ),
				'3.40',
				false
			);
			...
			wp_register_script(
				'select2',
				get_theme_file_uri( $js_dir_path . 'vendors/select2/select2.full.min.js' ),
				array( 'jquery' ),
				'4.0.2',
				false
			);
			...
			wp_register_script(
				'swipebox',
				get_theme_file_uri( $js_dir_path . 'vendors/swipebox/js/jquery.swipebox.min.js' ),
				array( 'jquery' ),
				'1.4.4',
				false
			);
			...
			wp_register_script(
				'sticky-kit',
				get_theme_file_uri( $js_dir_path . 'vendors/sticky-kit/sticky-kit.min.js' ),
				array( 'jquery' ),
				'1.1.2',
				false
			);
			...
			if ( 'true' === get_option( 'inspiry_optimise_js' ) && ! class_exists( 'iHomefinderAdmin' ) ) {
				...
				wp_enqueue_script(
					...
					get_theme_file_uri( $js_dir_path . 'vendors/realhomes-common-scripts.js' ),
					array( 'jquery' ),
					INSPIRY_THEME_VERSION,
					false
				);
			...
			if ( ! is_user_logged_in() ) {
				wp_enqueue_script(
					...
					get_theme_file_uri( $js_dir_path . 'js/inspiry-login-register.js' ),
					array( 'jquery' ),
					INSPIRY_THEME_VERSION,
					true
				);
	...
	function inspiry_enqueue_modern_scripts() {
		...
		if ( ! is_admin() ) {
			...
			if ( ! is_user_logged_in() ) {
				wp_enqueue_script(
					'inspiry-login',
					get_theme_file_uri( $js_dir_path . 'js/inspiry-login.js' ),
					array( 'jquery' ),
					INSPIRY_THEME_VERSION,
					true
				);
...
if ( ! function_exists( 'inspiry_enqueue_common_styles' ) ) {
	...
	function inspiry_enqueue_common_styles() {
		...
		wp_enqueue_style(
			'rh-font-awesome',
			get_theme_file_uri( $common_dir_path . 'font-awesome/css/font-awesome.min.css' ),
			array(),
			'4.7.0',
			'all'
		);
		...
		wp_enqueue_style(
			'owl-carousel-main',
			get_theme_file_uri( $common_dir_path . 'js/owl-carousel/assets/owl.carousel.min.css' ),
			array(),
			'2.3.4',
			'all'
		);
		...
		wp_enqueue_style(
			...
			get_theme_file_uri( $common_dir_path . 'js/owl-carousel/assets/owl.theme.default.min.css' ),
			array(),
			'2.3.4',
			'all'
		);
		...
		wp_enqueue_style(
			'venobox',
			get_theme_file_uri( $common_dir_path . 'js/venobox/venobox.css' ),
			array(),
			'1.8.5',
			'all'
		);
...
if ( ! function_exists( 'inspiry_enqueue_common_scripts' ) ) {
	...
	function inspiry_enqueue_common_scripts() {
		...
		wp_enqueue_script(
			'retina-js',
			get_theme_file_uri( $common_js_dir_path . 'retina.min.js' ),
			array( 'jquery' ),
			INSPIRY_THEME_VERSION,
			true
		);
		...
		wp_enqueue_script(
			'frontend-js',
			get_theme_file_uri( $common_js_dir_path . 'frontend-script.js' ),
			array( 'jquery' ),
			INSPIRY_THEME_VERSION,
			true
		);
		...
		wp_enqueue_script(
			'owl-carousel',
			get_theme_file_uri( $common_js_dir_path . 'owl-carousel/owl.carousel.min.js' ),
			array( 'jquery' ),
			'2.3.4',
			true
		);
		...
		wp_enqueue_script(
			'venobox-js',
			get_theme_file_uri( $common_js_dir_path . 'venobox/venobox.min.js' ),
			array( 'jquery' ),
			'1.8.5',
			true
		);
