...
if ( ! function_exists( 'rh_home_page_meta_boxes' ) ) {
	...
	function rh_home_page_meta_boxes( $meta_boxes ) {
		...
		$fields = array_merge( $fields, array(
			...
			array(
				'name'    => esc_html__( 'Background Image Overlay Opacity', 'framework' ),
		...
		if ( 'modern' == $design_variation ) {
			...
			$fields = array_merge( $fields, array(
				...
				array(
					...
					'type'    => 'textarea',
					'std'     => esc_html__( 'Some amazing features of Real Homes theme.', 'framework' ),
					'columns' => 12,
					'tab'     => 'home-properties',
					'visible' => array( 'theme_show_home_properties', 'true' )
				),
		...
		$fields = array_merge( $fields, array(
			...
			array(
				...
				'id'      => 'inspiry_cta_desc',
				'type'    => 'textarea',
				'std'     => esc_html__( 'Looking to Buy a new property or Sell an existing one? Real Homes provides an easy solution!', 'framework' ),
				'columns' => 12,
				'tab'     => 'call-to-action',
				'visible' => array( 'inspiry_show_cta', 'true' )
			),
			...
			array(
				...
				'type'    => 'textarea',
				'std'     => esc_html__( 'Some amazing partners of Real Homes theme', 'framework' ),
				'columns' => 12,
				'tab'     => 'partners',
				'visible' => array( 'inspiry_show_home_partners', 'true' )
			),
