...
<footer id="footer-wrapper">
	...
	<div id="footer-bottom" class="container">
		<div class="row">
			<div class="span6">
				<?php
				$copyright_text = apply_filters( 'inspiry_copyright_text', get_option( 'theme_copyright_text' ) );
			...
			<div class="span6">
				<?php
				$designed_by_text = apply_filters( 'inspiry_designed_by_text', get_option( 'theme_designed_by_text' ) );
