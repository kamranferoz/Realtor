																...
																<?php
																	...
																	if ( ! empty( $agent_whatsapp ) ) {
																		...
																		<li class="whatsapp">
																			...
																			?>
																			: <a href="tel:<?php echo esc_html( $agent_whatsapp ); ?>"><?php echo esc_html( $agent_whatsapp ); ?></a>
																		</li>
																		<?php
																	}
																?>
															...
															<?php
																if ( ! empty( $agent_office_phone ) ) {
																	...
																	esc_html_e( 'Office', 'framework' ); ?> : <a
                                                                            href="tel:<?php echo esc_html( $agent_office_phone ); ?>"><?php echo esc_html( $agent_office_phone ); ?></a></li>
                                                                    <?php
																}
																if ( ! empty( $agent_mobile ) ) {
																	?>
																	...
																	esc_html_e( 'Mobile', 'framework' ); ?> : <a
                                                                                href="tel:<?php echo esc_html( $agent_mobile ); ?>"><?php echo esc_html( $agent_mobile ); ?></a></li>
                                                                    <?php
																}
																if ( ! empty( $agent_office_fax ) ) {
																	?>
																	...
																	esc_html_e( 'Fax', 'framework' ); ?>  : <a
                                                                            href="fax:<?php echo esc_html( $agent_office_fax ); ?>"><?php echo esc_html( $agent_office_fax ); ?></a></li><?php
																}
																if ( ! empty( $agent_whatsapp ) ) {
																	?>
																	<li class="fax"><?php include( INSPIRY_THEME_DIR . '/images/icon-whatsapp.svg' );
																	esc_html_e( 'WhatsApp', 'framework' ); ?>  : <a
                                                                            href="tel:<?php echo esc_html( $agent_whatsapp ); ?>"><?php echo esc_html( $agent_whatsapp ); ?></a></li><?php
																}
															?>
														</ul>
														<?php
